...
class BluetoothSubmit extends StatefulWidget {
  const BluetoothSubmit({Key? key}) : super(key: key);

  @override
  State<BluetoothSubmit> createState() => _BluetoothSubmitState();
}
...
class _BluetoothSubmitState extends State<BluetoothSubmit> {
  ...
  submitStr(String str) {
    List<int> list = utf8.encode(str);
    Uint8List data = Uint8List.fromList(list);
    _ConnectedItem connectedItem = _connectedList[0];
    Device deviceToSubmit =  connectedItem._device;
    String strData = String.fromCharCodes(data);
    print("text debug ${connectedItem._name} / ${connectedItem._device} /  ${connectedItem._macAddress} / $data / ${strData}");
